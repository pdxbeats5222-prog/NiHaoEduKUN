  ...
  return (
    <div className="pt-32 pb-24 min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20 text-center">
        <h1 className="text-4xl md:text-6xl font-bold text-[#1d1d1f] tracking-tight mb-6">{t('Student Resources.')}</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-32">
        <h2 className="text-3xl md:text-4xl font-bold text-[#1d1d1f] tracking-tight mb-12 text-center">{t('10 Advantages of Studying in China.')}</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {[
            t("Diverse cultural experience"),
            t("Low tuition (1/4 of UK/US/AUS)"),
            t("High scholarship availability"),
            t("Safe & convenient living"),
            t("English-taught majors available"),
            t("Cutting-edge research"),
            t("Global job opportunities"),
            t("Highly recognized diplomas"),
            t("International courses"),
            t("Customized application services")
          ].map((adv, idx) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              <div className="flex items-center gap-3 mb-10">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[#1d1d1f] tracking-tight">{t('Enrollment Details.')}</h2>
              </div>
            ...
            <div>
              <div className="flex items-center gap-3 mb-10">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[#1d1d1f] tracking-tight">{t('Scholarship Opportunities.')}</h2>
              </div>
              <div className="space-y-6">
                <div className="p-8 bg-white rounded-[2rem] shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 border-t border-[#f5f5f7]">
        <div className="flex items-center justify-center gap-3 mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#1d1d1f] tracking-tight text-center">{t('Our University Partners & Dominant Majors.')}</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {universities.map((uni, idx) => (
            <div key={idx} className="bg-[#f5f5f7] p-8 rounded-[2rem]">
              ...
              <p className="text-sm text-[#86868b] leading-relaxed"><span className="font-semibold text-[#1d1d1f]">{t('Key Majors:')}</span> {uni.majors}</p>
            </div>
          ))}
        </div>
      </div>
